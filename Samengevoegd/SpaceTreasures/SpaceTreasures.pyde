import home_screen, player_menu, main_game, artefact_screen, new_turn, kaart_pak_scherm, create_element, intro, globals
...
def draw():
    ...
    elif globals.scherm == 'create_element':
        create_element.draw()
