...
def loadImages():
    global background_img, background_animation_images, pijlTerugPaars, pijlTerug2Paars, pijlTerugIdle, pijlVerderPaars, pijlVerder2Paars, pijlVerderIdle, alleFiches, fuelFiche, kaarten, planeetAarde, planeten, ruimteschepen
    ...
    alleFiches = loadImage('assets/images/unknown.png')
    fuelFiche = loadImage('assets/images/fuel_fiche.png')
    kaarten = loadImage('assets/images/kaarten.jpeg')
    planeetAarde = loadImage('assets/images/planeet_aarde.jpg')
    planeten = loadImage('assets/images/planeten.jpg')
    ruimteschepen = loadImage('assets/images/ruimteschepen.png')
